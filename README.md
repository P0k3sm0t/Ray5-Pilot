...
- Live X/Y machine position display
...
- Camera deskew/postprocess/rotation settings
- Live Console with smart auto-scroll
- Settings page
- No old LightBurn TCP bridge server

## Setup
1. Download or clone `Ray5-Pilot`.
...
- Keep laser enclosure, eye protection, air assist, and fire safety in place.
